...
int end_num_index;	         //индекс начала числа 
...
// заменяем подстроку в скобках на итоговый результат подсчетов
void Res_Str(char* arr, char* new_str) {
...
//результат выражения в скобках соединяем с основной строкой
void Res_Bracket_Str(char* arr, char* new_str, int a, int b) {
